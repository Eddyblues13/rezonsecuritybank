@include('home.header')
    ...
    <p class="card-text">At The Clay Premium Bank, we believe that your bank should support your dreams and aspirations. That’s why we have developed convenient mortgage solutions to help make your dream of owning your own business a reality...</p>
...
<img src="images/clients/logo3.jpg" alt="#">
    ...
    <p>Clay Premium Bank has the best online features for self service and also Quick Response Team for Customers who may need help in handling any financial issue in their transaction.</p>
                    </div>
                </div>
            </div>
