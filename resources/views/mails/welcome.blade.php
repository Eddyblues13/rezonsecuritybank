...
<head>
    ...
    <title>Rezon security Bank</title>
            ...
            <tbody>
                <tr class="proton-tr">
                    <td class="proton-td" colspan="10" style="">
                        ...
                        <center>
                            <h1>Greetings!</h1>
                            <img src="{{asset('dash/logo.png')}}" alt="Image" />
                        </center>

                        <br>
                        <center>
                            <h2>Welcome to Rezon security Bank</h2>
                        ...
                        <p style='line-height: 24px;margin-bottom:15px;'>
                            Thanks for joining Rezon security Bank as your new home. We're excited to have you on board!
                        </p>
                        <p style='line-height: 24px;margin-bottom:15px;'>
                            Account Details:
                        </p>
                ...
                <tr class="proton-tr">
                    <td class="proton-td" colspan="10" style="">
                        ...
                        <center>
                            <span style="color: #706d6b"> © 2024 Rezon security Bank</span>
                        </center>
