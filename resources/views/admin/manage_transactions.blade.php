...
<div class="main-panel">
	<div class="content bg-dark">
		<div class="page-inner">
			...
			@endif
			<div class="mt-2 mb-4">
				<h1 class="title1 text-light">Rezon Security Bank users lists</h1>
			</div>
											...
											<div class="form-row">
												<div class="form-group col-md-12">
													...
													<input type="text" id="input1"
														class="form-control bg-dark text-light" name="username"
														required>
												</div>
												<div class="form-group col-md-12">
						...
						<table class="table table-hover text-light">
							...
							<tbody id="userslisttbl">
								...
								<tr>
									...
									<td>{{$transactions->currency}}{{number_format($transactions->transaction_amount,
										2)}}</td>
									...
									@endif
									<td>{{ \Carbon\Carbon::parse($transactions->created_at)->format('D, M j, Y g:i A')
										}}</td>

									<td>
										@if($transactions->transaction_status == "0")
										<a href="{{ route('approve.transaction',$transactions->id) }}"
											class="btn btn-primary btn-sm"><i class="text-white fa fa-pencil"></i>
											Approve
										</a>
										@elseif($transactions->transaction_status == "1")
										<a href="{{ route('decline.transaction',$transactions->id) }}"
