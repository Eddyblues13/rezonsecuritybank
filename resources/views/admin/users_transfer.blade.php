...
<div class="main-panel">
    <div class="content bg-dark">
        <div class="page-inner">
            ...
            @endif
            <div class="mt-2 mb-4">
                <h1 class="title1 text-light">Users Transfers</h1>
            </div>
            <div>
            </div>
            <div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="pricing-table purple border p-4 card bg-dark shadow">
                        <div class="price-tag">
                            ...
                            <center><i>Name: {{$transfers->first_name}} {{$transfers->middle_name}}
                                    {{$transfers->last_name}}</i></center>


                        </div>
                        <!-- Features -->
                        <div class="pricing-features">
                            <div class="feature text-light">Email:<span class="text-light">{{$transfers->email}}</span>
                            </div>

                            <div class="feature text-light">Transfer Amount:<span
                                    class="text-light">{{$transfers->currency}}{{number_format($transfers->transfer_amount,
                                    2)}}</span></div>
