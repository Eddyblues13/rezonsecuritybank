...
<head>
    ...
    <title>Rezon security | Admin Dashboard</title>
        ...
        <div class="wrapper">
            <div class="main-header">
                ...
                <div class="logo-header" data-background-color="dark">
                    <a href="/home" class="logo" style="font-size: 27px; color:#fff;">
                       Rezon security
                    </a>
                ...
                <div class="sidebar-wrapper scrollbar scrollbar-inner">
                    <div class="sidebar-content">
                        ...
                        <ul class="nav nav-primary">
                            ...
                            <li class="nav-item    ">
                                <a href="{{url('manage-deposits')}}">
                                    <i class="fa fa-arrow-alt-circle-up" aria-hidden="true"></i>
                                    <p>Manage Deposits</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('manage-loans')}}">
                                    <i class="fa fa-arrow-alt-circle-up" aria-hidden="true"></i>
                                    <p>Manage Loans</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url('manage-transactions')}}">
                                    <i class="fa fa-arrow-alt-circle-up" aria-hidden="true"></i>
