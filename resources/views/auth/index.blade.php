...
<div class="swal-overlay swal-overlay--show-modal" tabindex="-1">
  ...
  </div><div class="swal-title" style="">Access Denied</div><div class="swal-text" style="">Hi {{Auth::user()->first_name}} {{Auth::user()->middle_name}} {{Auth::user()->last_name}}  , Your internet banking account is currently inactive. Kindly contact our live customer care representive. </div><div class="swal-footer"><div class="swal-button-container">

    <a href="{{route('logout')}}" class="swal-button swal-button--confirm">OK</a>
                ...
                <div class="nk-block nk-block-middle nk-auth-body">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des alert alert-pro alert-primary">
                                <p class="alert-text">Access the REZON SECURITY BANK panel using your Account ID and password.</p>
                            </div>
                        </div>
                    </div><!-- .nk-block-head -->
                    <form  action="{{ route('login') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-lg" required autocomplete="off" id="id" placeholder="Enter your Account ID" name="email">
                        </div><!-- foem-group -->
                        <div class="form-group">
                            <div class="form-label-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                <input type="password" class="form-control form-control-lg" id="pass" required placeholder="Enter your password" name="password">
                            </div>
                    ...
                    <center class="p-3">
                        <a href="{{route('terms')}}" class="btn btn-sm btn-secondary"><em class="icon ni ni-regen"></em>  Enroll for Online Banking</a>
                    </center>
                                </div><!-- .nk-block -->
