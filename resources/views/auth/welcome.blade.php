...
<div class="swal-overlay swal-overlay--show-modal" tabindex="-1">
  ...
  <div class="swal-title" style="">Congratulations</div><div class="swal-text" style="">Your account have been successfully registered, A confirmation email have been forwarded to the email address provided.({{Auth::user()->email}}) </div><div class="swal-footer"><div class="swal-button-container">
