...
- rezonsecuritybk.com ACCOUNT ID, PASSWORD and ACCOUNT PIN   you choose to identify 
...
d. rezonsecuritybk.com do not accept responsibility for any loss you or anybody else may suffer because any instructions or information you sent us are sent in 
error, fail to reach us or are distorted unless you have been the victim of fraud.

e. rezonsecuritybk.com do not accept responsibility for any loss you or anybody else may suffer because any instructions or information we send you fail to reach
 you or are distorted unless you have been the victim of fraud.

5. HOW WE CAN CHANGE THESE CONDITIONS

a. rezonsecuritybk.com change these conditions for any reason by giving you written notice or publishing the change on our website.
...
rezonsecuritybk.com service is available to you if you are 18 years of age or over.
</textarea>
                        <br><br>
                        <button id="btn1" class="btn btn-secondary"><a href="{{route('login')}}" style="color:white;">Decline</a></button>&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <button id="btn1" class="btn btn-primary"><a href="{{route('register')}}" style="color:white;">I Accept</a></button>
                        </form>
                    <!-- form -->
                        ...
                        <div class="slider-item">
                            <div class="nk-feature nk-feature-center">
                                ...
                                <div class="nk-feature-content py-4 p-sm-5">
                                    ...
                                    <p>We'll never send an email containing a link to rezonsecuritybk.com.<br> We'll never ask for your passwords or Secret Code.</p>
                                </div>
                            </div>
                        </div>
                        <!-- .slider-item -->
