                ...
                <div class="nk-block-head">
                    ...
                    <div class="nk-block-between-md g-4 card-bordered">
                        <div class="nk-block-head-content">
                            <h4 class="nk-block-title fw-normal">International Fund Transfer.</h4>
                            <div class="nk-block-des">
                                <p>
                                    International Fund Transfer is fast and safe way to send money across different
                                    countries. The funds are deposited into the recipient's bank account associated with
                                    the IBAN or Swift Code you have added.
                                </p>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                            <ul class="nk-block-tools gx-3">
                                <li><a href="{{route('transfer')}}"
                                        class="btn btn-primary btn-light text-light"><span>Local Transfer</span><em
                ...
                <ul class="nav nav-tabs mt-n3">
                    <li class="nav-item ">
                        <a class="nav-link active text-light" data-toggle="tab" href="#tabItem5"><em
                                class="icon ni ni-wallet-alt"></em> <span>Send Money</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" data-toggle="tab" href="#tabItem6"><em
                                class="icon ni ni-cc-new"></em><span>Add a Recipient</span></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <div class="form-control-wrap">
                                        <select type="text" name="recipient" class="form-control form-control-outlined "
                                            id="recipient" placeholder="">
                                            <option disabled="" selected=""> </option>
                                            <option disabled="" selected="">Select a Recipient</option>
                                            <option selected disabled>No recipient have been added</option>
                                        </select>
                                ...
                                <div class="buysell-field form-group col-md-12">
                                    ...
                                    <div class="form-note-group">
                                        <span class="buysell-min form-note-alt"></span> <span
                                            class="buysell-rate form-note-alt">*International Fund Transfer fee will be
                                            deducted</span>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined" id="description"
                                ...
                                <div class="form-group col-md-12">
                                    <button type="submit" class="btn btn-primary btn-block wireBtn"
                    ...
                    <div class="tab-pane" id="tabItem6">
                        ...
                        <form method="post" action="">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group"><label class="form-label" for="countryId">Country</label>
                                        <div class="form-control-wrap">
                                            <select class="form-control" id="countryId" name="country"
                                                onchange="formUp('countryId')" required="" data-msg="Select Country">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group"><label class="form-label" for="stateId">State</label>
                                        <script src="../assets/js/countries.js"></script>
                                        <div class="form-control-wrap">
                                            <select class="form-control" id="stateId" name="state"
                                                onchange="formUp('stateId')" required="" data-msg="Select State">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group"><label class="form-label" for="cityId">City</label>
                                        <div class="form-control-wrap">
                                            <input class="cities form-control" id="cityId" name="city" required=""
                                                data-msg="Enter City">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined" id="email"
                                            name="email">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined" id="fullname"
                                            name="fullname">
                                        <label class="form-label-outlined" for="outlined">Recipient fullname </label>
                                    </div>
                                </div>
                                <div class="form-group col-md-12">
                                    <select type="text" class="form-control form-control-outlined" id="type" name="type"
                                        placeholder="">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined" id="iban"
                                            name="iban">
                                        <label class="form-label-outlined" for="outlined">IBAN</label>
                                        <small>You will have to provide the IBAN for European countries, or the ABA for
                                            the United States.
                                        </small>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined" id="swiftcode"
                                            name="swiftcode">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-outlined"
                                            onkeyup="showHint(this.value)" id="accountnumber" name="accountnumber">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="form-control-wrap">
                                        <button onclick="" type="submit" class="btn btn-primary btn-block addRecipient"
