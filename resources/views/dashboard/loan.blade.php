...
<div class="nk-content nk-content-fluid">
            ...
            <div class="page-inner">
                ...
                <div class="buysell">
                    ...
                    <div class="buysell-title text-center">
                        <h2 class="title">Apply For REZON SECURITY BANK Loan</h2>
                    </div><!-- .buysell-title -->
                    <div class="buysell-block">
                        <form action="{{route('request.loan')}}" class="buysell-form" id="loanRequest" method="post">
                            @csrf
                            ...
                            <div class="buysell-field form-group">
                                ...
                                <div class="form-control-group">
                                    <input type="number" step="any"
                                        class="form-control form-control-lg form-control-number" id="amount" min="150"
                                        max="150000" name="amount" placeholder="200.00" required>
                                    <div class="form-dropdown">
                                        <div class="text">USD</div>
                                    </div>
                                </div>
                                <div class="form-note-group">
                                    <span class="buysell-min form-note-alt">Minimum:150
                                        {{Auth::user()->currency}}</span>
                                    <span class="buysell-rate form-note-alt">Maximum:150,000
                                        {{Auth::user()->currency}}</span>
                                </div>
                            </div><!-- .buysell-field -->
                            <div class="row">
                                <div class="buysell-field form-group col-lg-6">
                                    ...
                                    <div class="form-control-group">
                                        <select type="text" class="form-control form-control-lg" id="facility"
                                            ...
                                            <option value="StartUp/Products Financing">StartUp/Products Financing
                                            </option>
                                            ...
                                            <option value="Revenue Loans and Overdraft">Revenue Loans and Overdraft
                                            </option>
                                ...
                                <div class="buysell-field form-group col-lg-6">
                                    ...
                                    <div class="form-control-group">
                                        <select type="text" class="form-control form-control-lg" id="tenure"
                                ...
                                <div class="buysell-field form-group col-lg-12">
                                    ...
                                    <div class="form-control-group">
                                        <textarea type="text" class="form-control form-control-lg" cols="8" id="reason"
                                            name="reason"
                                            placeholder="Briefly exlain why you're requesting for this {{route('loan')}}"
                                            required></textarea>
                                    </div>
                            ...
                            <hr>
                            <p class="title lead">You are requesting for an instant loan, By continueing, you have
                                agreed
                                and accepted the REZON SECURITY BANK digital loan terms and conditions.</p>
                            <strong class="text-center bold">Terms & Conditions</strong>
                            <ul class="list list-sm list-checked">
                                <li>Interest Rate: 4.3%.</li>
                                <li>Management Fee: 3%.</li>
                                <li>Credit Life Insurance Fee: 0.8%.</li>
                                <li>Penal Charge: 3.5%.</li>
                                ...
                                <li>I accept that REZON SECURITY BANK reserved the right to decline my loan request.
                                </li>
                            </ul>
                            <div id="Result"></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (e) {
		    ...
		    e.preventDefault();
		    $.ajax({
        	url: "../scripts/auth?action=accept{{route('loan')}}",
			type: "POST",
			data:  new FormData(this),
			contentType: false,
    	    cache: false,
