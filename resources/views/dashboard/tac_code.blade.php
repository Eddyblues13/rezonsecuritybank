        ...
        <div class="nk-content-body">
            ...
            <div class="buysell wide-xs m-auto">
                <div class="buysell-title text-center">
                    ...
                    <h2 class="title">TAC Code is required.</h2>
                </div><!-- .buysell-title -->
                <div class="buysell-block">
                    ...
                    <form action="{{route('final.transfer')}}" method="post">
                        ...
                        <div class="buysell-field form-group">
                            <div class="form-label-group">
                                <strong class="form-label text-danger text-left">
                                    The TAC code is required for this transaction to be completed successfully. You can
                                    contact our online customer care representative for more details on the TAC code for
                                    this transaction.
                                </strong>
                            </div>
                        </div><!-- .buysell-field -->
                        <div class="buysell-field form-group">
                            <div class="">
                                <label class="form-label font-weight-bold" for="">Enter TAC Code:</label>
                            </div>

                            <div class="form-control-group">
                                <input type="number" value="{{$transfer->transfer_amount}}"
