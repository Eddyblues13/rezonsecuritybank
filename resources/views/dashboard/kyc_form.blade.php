                        ...
                        <div class="nk-kycfm">
                            <div class="nk-kycfm-head">
                                ...
                                <div class="nk-kycfm-title">
                                    ...
                                    <p class="sub-title">Your simple personal information required for identification
                                    </p>
                                </div>
                            </div><!-- .nk-kycfm-head -->
                            <div class="nk-kycfm-content">
                                <div class="nk-kycfm-note">
                                    ...
                                    <p>Please type carefully and fill out the form with your personal details. Your
                                        can’t edit these details once you submitted the form.</p>
                                </div>
                                <script>
                                    if ("session('error')") {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-group">
                                                    <input type="text" id="dob" name="date_of_birth"
                                                        ...
                                                        class="form-control form-control-lg date-picker" required>
                                                </div>
                                            </div>
                                        </div><!-- .col -->
                                        <div class="col-md-6">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-group">
                                                <input type="text" class="form-control form-control-lg" id="address_one"
                                                    name="address_one" value="{{Auth::user()->address_one}}" required>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-group">
                                                <input type="text" id="state" name="state"
                                                    value="{{Auth::user()->state}}" class="form-control form-control-lg"
                                                    required>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-group">
                                                <input type="text" id="nationality" name="country"
                                                    value="{{Auth::user()->country}}"
                                                    class="form-control form-control-lg date-picker-alt" required>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                    <div class="col-md-6">
                            ...
                            <div class="nk-kycfm-head">
                                ...
                                <div class="nk-kycfm-title">
                                    ...
                                    <p class="sub-title">To verify your identity, please upload any of your document.
                                    </p>
                                </div>
                            </div><!-- .nk-kycfm-head -->
                            <div class="nk-kycfm-content">
                                ...
                                <ul class="nk-kycfm-control-list g-3">
                                    <li class="nk-kycfm-control-item">
                                        <input class="nk-kycfm-control" type="radio" name="id_type" value="passport"
                                            id="passport" data-title="Passport" checked required>
                                                ...
                                                <div class="label-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <path
                                                            ...
                                                            transform="translate(-3.9995 -2.101)" fill="#6476ff" />
                                                    </svg>
                                                </div>
                                            </span>
                                    ...
                                    <li class="nk-kycfm-control-item">
                                        <input class="nk-kycfm-control" type="radio" value="national-id" name="id_type"
                                            id="national-id" data-title="National ID" required>
                                    ...
                                    <li class="nk-kycfm-control-item">
                                        <input class="nk-kycfm-control" type="radio" value="driver-licence"
                                            name="id_type" id="driver-licence" data-title="Driving License" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-md-12 p-0">
                                                <img class="img-responsive" id="output_imageB" src="images/id-front.png"
                                                    style="width:100%; height:130px">
                                            </div>
                                            <p class="clear-fix"></p>
                                            <div class="form-control-wrap">
                                                <div class="custom-file">
                                                    <input type="file" name="front" class="custom-file-input"
                                                        id="fileTag" accept="image/*" onchange="preview_imageB(event)"
                                                        required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="col-md-12 p-0">
                                                <img class="img-responsive" id="output_image" src="images/id-back.png"
                                                    style="width:100%; height:130px">
                                            </div>
                                            <p class="clear-fix"></p>
                                            <div class="form-control-wrap">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="back"
                                ...
                                <div class="nk-kycfm-footer">
                                    <div class="form-group">
                                        <div class="custom-control custom-control-xs custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="tc-agree">I Have Read The <a
                                                    href="privacy">Terms Of Condition</a> And <a href="privacy">Privacy
                                                    Policy</a></label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="nk-kycfm-action pt-2">
                                        <button type="submit" class="btn btn-lg btn-primary cardBtn">Submit</button>
                                    </div>
                                </div><!-- .nk-kycfm-footer -->
                            </div>
                            </form>
                ...
                <div class="card-inner card-inner-lg">
                    <div class="nk-kyc-app p-sm-2 text-center">
                        ...
                        <div class="nk-kyc-app-text mx-auto">
                            <p class="lead">Your KYC has been submitted and is awaiting confirmation. Expect feedback
                                within 2-3 working days. Thank you!</p>
                        </div>
                        {{-- <div class="nk-kyc-app-action">
                            <strong>Ref:</strong><br>
                            <pre>{{ Auth::user()->kyc_ref ?? 'N/A' }}</pre>
                            <strong>Date submitted:</strong><br>
                            <pre>{{ Auth::user()->kyc_date ?? 'N/A' }}</pre>
                        </div> --}}
                    </div>
                </div>
            </div>
