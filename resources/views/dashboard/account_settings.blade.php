        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des">
                    <p>These settings are helps you keep your REZON SECURITY BANK account secure.</p>
                </div>
            </div>
        </div>
        <!-- .nk-block-head -->
                    ...
                    <div class="between-center flex-wrap flex-md-nowrap g-3">
                        ...
                        <div class="nk-block-actions">
                            <ul class="align-center gx-3">
                                ...
                                <li>
                                    <a href="{{route('activity_log')}}" class="link link-sm link-primary">See Recent
                                        Activity</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="card-inner">
                    <div class="between-center flex-wrap flex-md-nowrap g-3">
                        <div class="nk-block-text">
                            ...
                            <p>You can set your pin code, we will ask you this code during login attempts and
                                transactions.</p>
                        </div>
                        <div class="nk-block-actions">
                            <div class="custom-control custom-switch mr-n2">
                    ...
                    <div class="between-center flex-wrap flex-md-nowrap g-3">
                        <div class="nk-block-text">
                            ...
                            <p>Secure your account with 2FA security. When it is activated you will need to enter not
                                only your password, but also a special code using app. You can receive this code by in
                                mobile app. </p>
                        </div>
        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-head-content">
                <div class="nk-block-title-group">
                    ...
                    <a href="{{route('activity_log')}}" class="link">See full log</a>
                </div>
                <div class="nk-block-des">
